...
- NCD có tính lỏng cao hơn CD do CD không thể chuyển nhượng lại
...
- Là **hối phiếu** do công ty ký phát và **được ngân hàng bên bị kí phát đảm bảo thanh toán** bằng cách đóng dấu 'đã chấp nhận' lên hối phiếu
	...
	- Người mua sẽ được ngân hàng đảm bảo thanh toán
...
- **Đặc điểm :** 
	...
	- Giá trị:
		- Mệnh giá (Face/Par value): giá ghi trên cổ phiếu
...
- **Phân loại :**
	- *Căn cứ vào quyền lợi cổ đông:*
		1. Cổ phiếu thường (Common Stock):
			...
			- Cổ tức phụ thuộc vào lợi nhuận công ty
			- Quyền tham gia quản lý công ty
			- Thứ tự chia lãi: Bond > Preferred Stock > Common Stock
		2. Cổ phiếu ưu đãi (Preferred Stock):
			< opposed to common stock >
	- *Căn cứ vào tính chất lưu hành:*
		1. Cổ phiếu đang lưu hành (Outstanding Stock):
			$$Outstanding\ Share = Issued\ Share - Treasury\ Share$$
		2. Cổ phiếu quỹ (Treasury Stock):
			- Là số cổ phiếu đã phát hành và được chính công ty mua lại
...
- **Đặc điểm :**
	...
	- Lãi trái phiếu (Coupon):
		- Đối với Coupon Bond: là khoản lãi định kì xác định bằng % mệnh giá (Coupon Rate)
		- Đối với Discount Bond/Zero-coupon Bond: là khoản chênh lệch giữa giá bán lúc phát hành và mệnh giá
	- Các ***điều khoản đặc biệt*** có thể kèm theo:
		- Lãi suất thả nổi (Floating-rate Bond)
		- Lãi suất cố định (Fixed-rate Bond)
		- Đáo hạn chuỗi (Serial Bond)
...
- **Phân loại :** :
	...
	- *Theo chủ thể phát hành*:
		1. Trái phiếu chính phủ (Government Bond):
			...
			- Công trái nhà nước (State Bond)
		2. Trái phiếu chính quyền địa phương (Municipal Bond)
