...
&= NI + D\&A - CAPEX - \Delta WC + Net\ Borrowings\\\\
...
- **Trì hoãn các khoản phải trả**
	- Lọc ra những khoản chi dự kiến mà không ảnh hưởng tới HĐKD của DN
	- Đàm phàn với nhà cung cấp
- **Tìm kiếm nguồn tiền bổ sung tạm thời**
	- Vay thấu chi 
		- Cho mục đích ngắn hạn
		- Giá trị không lớn
		- Lãi suất < lãi vay kỳ hạn
		- Có thể không cần tài sản đảm bảo
		- NH có quyền yêu cầu thanh toán bất cứ lúc nào
	- Vay kỳ hạn
		 `<< as opposed to vay thấu chi >>`