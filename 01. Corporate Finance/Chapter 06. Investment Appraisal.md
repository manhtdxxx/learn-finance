...
- Một dự án đầu tư điển hình thu nhập của dự án bao gồm:
	- **Dòng tiền thuần từ hoạt động kinh doanh** hàng năm gồm:
		...
		- Trong TH chi phí bao gồm lãi vay để tính thuế TNDN, thì khi tính dòng tiền lãi vay được cộng lại như khấu hao do lãi vay thuộc dòng tiền từ hoạt động tài chính, đó không phải là chi phí dùng trong hoạt động kinh doanh  `<< cái này tùy nha, theo chuẩn mực kế toán mỗi quốc gia khác nhau >>`
		$$
		\begin{align}
