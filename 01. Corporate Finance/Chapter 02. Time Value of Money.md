...
### 1.1 Simple Interest & Compound Interest
...
##### 1.2.1 Giá trị tương lai của 1 khoản tiền
...
###### 1.2.2.1 Dòng tiền đều ở cuối kỳ (**ordinary annuity**)
...
\end{align}
$$
###### 1.2.2.2 Dòng tiền đều ở đầu kỳ (**annuity due**)
...
\end{align} 
$$
##### 1.2.3 Giá trị tương lai của dòng tiền biến thiên
...
##### 1.3.1 Giá trị hiện tại của 1 khoản tiền
$$PV = FV_n \cdot \frac{1}{(1 + i)^n} = FV_n \cdot PVF(i,n)$$
##### 1.3.2 Giá trị hiện tại của dòng tiền đều
###### 1.3.2.1 Dòng tiền đều cuối kì
...
\end{align}
$$
###### 1.3.2.3 Dòng tiền đều vô hạn **(perpetuity)**
- Khi n --> +∞   thì   (1/(1+i))^n --> 0
$$
\begin{align}
