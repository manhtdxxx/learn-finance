...
### 1.1. Overview
- TSCĐ là tài sản thỏa mãi các tiêu chuẩn sau:
...
Mức\ KH\ hàng\ năm &= \frac{Giá\ trị\ phải\ trích\ KH}{Năm\ sử\ dụng}\\\\
...
- TSCĐ áp dụng được phương pháp này phải thỏa các ĐK sau:
	...
	- Công suất sử dụng thực tế bình quân hàng năm >= 100% công suất thiết kế
- **Công thức** :
	$$
	\begin{align}
	Mức\ KH\ trên\ 1\ đvsp &= \frac{Nguyên\ giá}{Tổng\ sản\ lượng\ theo\ cả\ đời\ của\ TSCĐ}\\\\
	Mức\ KH\ hàng\ năm &= Sản\ lượng\ trong\ năm \cdot Mức\ KH\ trên\ 1\ đvsp
	\end{align}
	$$
---
...
$$
\begin{align}
Hệ\ số\ hao\ mòn\ TSCĐ &= \frac{Số\ tiền\ khấu\ hao\ lũy\ kế}{Nguyên\ giá\ TSCĐ\ ở\ thời\ điểm\ đánh\ giá} &(1)\\\\
...
- **Vốn lưu động** của DN là số vốn ứng ra để để hình thành nên tài sản lưu động nhằm đảm bảo cho quá trình kinh doanh của doanh nghiệp được thực hiện thường xuyên, liên tục
