...
- Lãi suất khoản vay dài hạn có thể theo 2 cách :
	- *Lãi suất cố định* : dựa trên thời gian đáo hạn và mức độ rủi ro; thường > lãi suất trái phiếu DN có thời gian đáo hạn và mức độ rủi ro tương tự
	- *Lãi suất thả nổi* : lãi suất ban đầu ổn định + phần tăng thêm do rủi ro
- **Ưu điểm** :
	- Người cho vay có thể xếp lịch trả nợ phù hợp với dòng tiền thu nhập của người vay
	- Thủ tục phát hành trái phiếu mất thời gian và chi phí phát hành
- **Nhược điểm** :
	- Đi kèm với những điều khoản có thể hạn chế khả năng hoạt động của DN
	- Lãi suất khi theo thả nổi sẽ biến động
...
- **Điểm cân bằng EBIT (điểm bàng quan) - Indifference Point**
	...
	- Công thức:
		...
		- `I1,2: lãi vay phải trả khi tài trợ bằng phương án 1,2`
		- `t: thuế suất thuế thu nhập doanh nghiệp`
		- `NS1,2: số lượng cổ phần phổ thông đang lưu hành ứng với phương án 1,2`
		$$
		\begin{align}
		EPS_1 &= EPS_2\\
