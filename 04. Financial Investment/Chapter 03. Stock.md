...
- Yếu tố phân tích:
	...
	- Rủi ro chính trị
- Ảnh hưởng tới:
	- Triển vọng xuất khẩu của công ty
	- Sự cạnh tranh về giá với đối thủ nước ngoài
	- Lợi nhuận đạt được từ đầu tư nước ngoài
##### 1.1.2. Domestic Macroeconomy
- **GDP** - tổng sản phẩm hàng hóa và dịch vụ của nền kinh tế
	- GDP tăng nhanh cho thấy các DN đang mở rộng doanh số
...
-  Lí thuyết về cung cầu vốn vay *(Loanable Funds Theory)* là lí thuyết cho rằng lãi suất thị trường bị tác động bởi các yếu tố tác động tới cung và cầu của các món cho vay
	...
	- Giao điểm của cung cầu vốn xác định *lãi suất cân bằng thị trường*. Bất kì một yếu tố làm làm cho lãi suất lệch khỏi lãi suất cân bằng, đều làm cho người cho vay và người đi vay cạnh tranh nhau và đưa mức lãi suất trở về cân bằng
- Phân tích:
...
- VD:
	...
	- Chính sách đối đối với người lao động, đào tạo đội ngũ lao động
...
- Perter Lynch phân chia các công ty theo 6 nhóm:
	...
	2. **Stalwarts – Doanh nghiệp ổn định**
		...
		- Đặc điểm:
		    - Công ty lớn, có sức mạnh tài chính
		    - Tăng trưởng vừa phải (10-12%/năm)
		    - Ít rủi ro, là lựa chọn ổn định
		- Ngành ví dụ: FMCG, dược phẩm...
...
- **Differentiation - Chiến lược khác biệt hóa**
	...
	- ❌ Nhược điểm:
		- Chi phí sản xuất và marketing cao hơn để duy trì sự khác biệt
		- Khó duy trì lợi thế nếu đối thủ bắt chước hoặc cải tiến nhanh
		- Khách hàng có thể không đánh giá cao sự khác biệt nếu không thấy giá trị
- **Focus Strategy - Chiến lược tập trung**
	- Doanh nghiệp *tập trung* thực hiện chiến lược vào *một phân khúc thị trường nhỏ* 
	- 2 biến thể:
		- Cost Focus - Tập trung chi phí thấp
...
- **Dupont Analysis :**
	...
	&= \frac{\text{Net Income}}{\text{Sales}} \cdot \frac{\text{Sales}}{\text{Assets}} \cdot \frac{\text{Assets}}{\text{Equity}}\\\\
...
- **Company's Growth Rate :**
	...
	&= \frac{\text{Retained Earnings}}{\text{Net Income}} \cdot \frac{\text{Net Income}}{\text{Equity}}\\\\
	&= \frac{\text{Retained Earnings}}{\text{Equity}}
	\end{align}
	$$
# 2. Valuation
### 2.1. Absolute Valuation Methods
##### 2.1.1 Dividend Discount Model (DDM)
- **Gordon Growth Model**
	- Cổ tức *tăng trưởng hằng năm* với *tỉ lệ cố định `g`*
	$$
	\begin{align}
	P_0 = \frac{D_1}{r_e - g} = \frac{D_0 \cdot (1 + g)}{r_e - g}
	\end{align}
	$$
	- Trong đó 
...
- **Two-Stage DDM**
	...
	P_n &= \frac{D_{n + 1}}{r_2 - g_2} = \frac{D_n \cdot (1 + g_2)}{r_2 - g_2} = \frac{D_0 \cdot (1 + g_1)^t \cdot (1 + g_2)}{r_2 - g_2}
	\end{align}
	$$
	---
- **Three-Stage DDM**
	...
	\begin{align}
	P_0 &= \sum_{t=1}^n \frac{D_0 \cdot (1 +g_1)^t}{(1 + r_1)^{t}} + \frac{P_n}{(1 + r_1)^n}\\\\
	P_n &= \sum_{t=n+1}^m \frac{D_t}{(1 + r_t)^t} + \frac{P_m}{(1 + r_m)^m}\\\\
	P_m &= \frac{D_{m+1}}{r_2 - g_2} =\frac{D_m \cdot (1 + g_2)}{r_2 - g_2}
	\end{align}
	$$
...
$$
\begin{align}
P/FCF &= \frac{Market\ Capitalization}{FCF}\\\\
...
$$
\begin{align}
EV/EBITDA &= \frac{EV}{Adjusted\ EBITDA}\\\\
